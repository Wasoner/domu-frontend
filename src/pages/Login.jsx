...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (/\s/.test(formData.email)) {
            setError('El correo no puede contener espacios. Revisa y vuelve a intentar.');
            return;
        }
        setLoading(true);
                    ...
                    <div className="login-container fade-in">
                        <div className="login-card">
                            <section className="login-intro">
                                <p className="login-intro__eyebrow">Acceso seguro</p>
                                <h1>Iniciar sesión</h1>
                                <p className="login-intro__lead">
                                    Accede al portal de tu comunidad para revisar gastos comunes, reservas y comunicaciones.
                                </p>
                                <ul className="login-intro__list">
                                    <li>Portal para residentes y administradores</li>
                                    <li>Datos protegidos con cifrado</li>
                                    <li>Acceso desde web y móvil</li>
                                </ul>
                            </section>

...
import { Icon, Button, FormField, NeighborProfileModal, MarketCard, ConfirmModal } from '../components';
...
const ResidentMarketplace = () => {
    ...
    return (
        <ProtectedLayout allowedRoles={['resident', 'admin', 'concierge']}>
            <div className="resident-marketplace page-shell">
                                        ...
                                        {showDetail.userId === user.id ? (
                                            <div className="market-modal__my-actions">
                                                ...
                                                <Button 
                                                    variant="ghost" 
                                                    fullWidth
                                                    onClick={() => setConfirmAction({ type: 'delete', itemId: showDetail.id })}
                                            ...
                                            <>
                                                <div className="market-modal__seller-info">
                                                    <div className="market-modal__seller-avatar">
                                                        {showDetail.sellerPhotoUrl ? (
                                                            <img src={showDetail.sellerPhotoUrl} alt="" />
                                                        ) : (
                ...
                <ConfirmModal
                    ...
                    message="Esta acción no se puede deshacer. El anuncio será eliminado permanentemente."
